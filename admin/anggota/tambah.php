                    ...
                    <div>
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                            <div>
                                ...
                                <input type="text" name="nama" class="w-full px-5 py-3 bg-gray-50 border border-gray-200 rounded-xl focus:outline-none focus:ring-2 focus:ring-blue-500 transition" required>
                            </div>
                            <div>
                                <label class="block text-sm font-bold text-gray-700 mb-2">NIM <span class="text-red-500">*</span></label>
                                <input type="text" name="nim" class="w-full px-5 py-3 bg-gray-50 border border-gray-200 rounded-xl focus:outline-none focus:ring-2 focus:ring-blue-500 transition" required>
                            </div>
                            <div>
                                <label class="block text-sm font-bold text-gray-700 mb-2">Angkatan <span class="text-red-500">*</span></label>
                                <input type="number" name="angkatan" class="w-full px-5 py-3 bg-gray-50 border border-gray-200 rounded-xl focus:outline-none focus:ring-2 focus:ring-blue-500 transition" placeholder="Contoh: 2024" required>
                            </div>
                            <div>
                    ...
                    <div>
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                            <div>
                                ...
                                <input type="text" name="jabatan" class="w-full px-5 py-3 bg-gray-50 border border-gray-200 rounded-xl focus:outline-none focus:ring-2 focus:ring-blue-500 transition" placeholder="Contoh: Anggota">
                            </div>
                            <div>
                    ...
                    <div>
                        ...
                        <div class="flex flex-col md:flex-row items-center gap-6 bg-gray-50 p-6 rounded-2xl border border-dashed border-gray-300">
                            <div class="shrink-0 relative">
                                <img id="preview-foto" class="h-24 w-24 object-cover rounded-full border-4 border-white shadow-md" src="https://ui-avatars.com/api/?name=User+Baru&background=eff6ff&color=1d4ed8" alt="Preview Foto" />
                            ...
                            <div class="w-full">
                                ...
                                " accept="image/*"/>
                                <p class="text-xs text-gray-400 mt-2">Format: JPG, PNG, WEBP. Maksimal 2MB. Disarankan rasio 1:1 (Persegi).</p>
                            </div>
                        </div>
                    </div>

                    <div class="bg-yellow-50 p-6 rounded-xl border border-yellow-100">
                        <h3 class="text-sm font-bold text-yellow-800 mb-2"><i class="fas fa-lock mr-2"></i>Info Login</h3>
                        <p class="text-xs text-yellow-700">Password default: <strong>nim123</strong>. Anggota dapat menggantinya nanti.</p>
                    </div>

                    <div class="pt-6 border-t border-gray-100">
                        <button type="submit" class="px-8 py-3.5 bg-blue-600 hover:bg-blue-700 text-white font-bold rounded-xl shadow-lg transition w-full md:w-auto">
