    ...
    <div class="container mx-auto px-6">
        <div class="flex flex-col md:flex-row justify-between items-start md:items-center gap-4">
            <div>
                ...
                <h1 class="text-3xl font-extrabold text-gray-900 leading-tight">Tambah Agenda Baru</h1>
            </div>
            ...
            <div class="p-8 md:p-10">
                ...
                <form action="proses_tambah.php" method="POST" enctype="multipart/form-data" class="space-y-8">
                    ...
                    <div>
                        ...
                        <input type="text" name="judul" class="w-full px-5 py-3 bg-gray-50 border border-gray-200 rounded-xl focus:outline-none focus:ring-2 focus:ring-blue-500 transition" placeholder="Contoh: Workshop Web Development" required>
                    </div>
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-8">
                        ...
                        <div>
                            ...
                            <input type="text" name="lokasi" class="w-full px-5 py-3 bg-gray-50 border border-gray-200 rounded-xl focus:outline-none focus:ring-2 focus:ring-blue-500 transition" placeholder="Contoh: Gedung PKM UIN Suska" required>
                        </div>
                    </div>
                    ...
                    <div>
                        ...
                        <div class="flex items-center justify-center w-full">
                            <label for="dropzone-file" class="flex flex-col items-center justify-center w-full h-56 border-2 border-gray-300 border-dashed rounded-2xl cursor-pointer bg-gray-50 hover:bg-blue-50 hover:border-blue-400 transition group relative overflow-hidden">
                                <div class="flex flex-col items-center justify-center pt-5 pb-6 text-center px-4">
                                    <img id="preview-image" class="hidden h-48 object-contain rounded-lg shadow-sm z-10" />
                                    <div id="upload-placeholder">
                                        <i class="fas fa-image text-4xl text-gray-400 mb-3 group-hover:text-blue-500 transition"></i>
                                        <p class="mb-2 text-sm text-gray-500"><span class="font-semibold text-blue-600">Klik untuk upload</span></p>
                                        <p class="text-xs text-gray-400">Rasio disarankan Potrait (9:16)</p>
                                    </div>
                                </div>
                    ...
                    <div>
                        ...
                        <textarea name="deskripsi" rows="6" class="w-full px-5 py-3 bg-gray-50 border border-gray-200 rounded-xl focus:outline-none focus:ring-2 focus:ring-blue-500 transition leading-relaxed" placeholder="Jelaskan detail kegiatan..."></textarea>
                    </div>

                    <div class="pt-6 border-t border-gray-100 flex items-center gap-4">
                        <button type="submit" name="simpan" class="px-8 py-3.5 bg-blue-600 hover:bg-blue-700 text-white font-bold rounded-xl shadow-lg transition w-full md:w-auto flex justify-center items-center gap-2">
