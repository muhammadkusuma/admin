                ...
                <form action="proses_tambah.php" method="POST" enctype="multipart/form-data" class="space-y-8">
                    ...
                    <div>
                        ...
                        <input type="text" name="judul"
                            ...
                            placeholder="Contoh: Workshop Web Development" required>
                    </div>
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-8">
                        ...
                        <div>
                            <label class="block text-sm font-bold text-gray-700 mb-2">Tanggal Pelaksanaan <span
                                    class="text-red-500">*</span></label>
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-8">
                        ...
                        <div>
                            ...
                            <input type="text" name="lokasi"
                                class="w-full px-5 py-3 bg-gray-50 border border-gray-200 rounded-xl focus:outline-none focus:ring-2 focus:ring-blue-500 transition"
                                placeholder="Contoh: Gedung PKM UIN Suska" required>
                        </div>
                        <div>
                            <label class="block text-sm font-bold text-gray-700 mb-2">Link Pendaftaran
                                (Opsional)</label>
                            <input type="url" name="link_pendaftaran"
                                class="w-full px-5 py-3 bg-gray-50 border border-gray-200 rounded-xl focus:outline-none focus:ring-2 focus:ring-blue-500 transition"
                                placeholder="Contoh: https://bit.ly/DaftarSeminar atau https://forms.google.com/...">
                            <p class="text-xs text-gray-400 mt-1">Kosongkan jika tidak ada pendaftaran online.</p>
                        </div>
                    </div>
                    ...
                    <div>
                        ...
                        <div class="flex items-center justify-center w-full">
                            <label for="dropzone-file"
                                class="flex flex-col items-center justify-center w-full h-56 border-2 border-gray-300 border-dashed rounded-2xl cursor-pointer bg-gray-50 hover:bg-blue-50 hover:border-blue-400 transition group relative overflow-hidden">
                                <div class="flex flex-col items-center justify-center pt-5 pb-6 text-center px-4">
                                    <img id="preview-image"
                                        class="hidden h-48 object-contain rounded-lg shadow-sm z-10" />
